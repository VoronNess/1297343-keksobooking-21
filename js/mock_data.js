  ...
  const createMapCards = (count) => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      const offer = {
        ...
        type: window.util.getRandomArrayElement(window.constants.ADVERTISEMENT_TYPES),
        ...
        photos: [window.constants.ADVERTISEMENT_PHOTOS[1], window.constants.ADVERTISEMENT_PHOTOS[2]],
      };
