...
(function () {
  ...
  const MAIN_PIN_LEFT_VALUE = MAIN_PIN.offsetLeft;

  const MAIN_PIN_TOP_VALUE = MAIN_PIN.offsetTop;
  const DEFAULT_ADDRESS_X = MAIN_PIN_LEFT_VALUE + HALF_MAIN_PIN;
  const DEFAULT_ADDRESS_Y = MAIN_PIN_TOP_VALUE + HALF_MAIN_PIN;

  const PAGE_IS_ACTIVE_ADDRESS_X = DEFAULT_ADDRESS_X;
  const PAGE_IS_ACTIVE_ADDRESS_Y = DEFAULT_ADDRESS_Y + HALF_MAIN_PIN + MAIN_PIN_POINTER_HEIGHT;
